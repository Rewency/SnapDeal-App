...
import com.example.snapdeal.ViewHolder.CartViewHolder;
import com.example.snapdeal.model.Cart;
...
public class CartActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Cart> options=new FirebaseRecyclerOptions.Builder<Cart>()
                .setQuery(cartListRef.child("User View").child(Prevalent.CurrOnlineUser.getPhone()).child("Products"),Cart.class).build();
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter=new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull final Cart cart)
            {
                ...
                oneTypeProductPrice=(Integer.parseInt(cart.getPrice().replaceAll("\\D+",""))) * Integer.parseInt(cart.getQuantity());
